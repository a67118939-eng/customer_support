...
import com.supportfaq.customersupportfaqaiagent.service.DashboardService;
...
public class DashboardController {
    ...
    public DashboardController(UnansweredQuestionRepository unansweredQuestionRepository,
                               DashboardService dashboardService, ChatService chatService,
                               FaqService faqService, SupportTicketService supportTicketService) {
    ...
    @PutMapping("/unanswered/{id}/review")
    ...
    @PostMapping("/unanswered/{id}/create-faq")
    ...
    @PostMapping("/unanswered/{id}/ticket")
